...
answer_path = f"/HOME/paratera_xy/pxy368/HDD_POOL/yuting/inference/model_answer/{args.benchmark}/{args.model}_answer.json"

save_path = f"/HOME/paratera_xy/pxy368/HDD_POOL/yuting/inference/judge/{args.benchmark}/{args.model}_answer.json"
...
# Create an LLM.
llm = LLM(model='/HOME/paratera_xy/pxy368/HDD_POOL/yuting/models/Qwen2.5-32B-Instruct',tensor_parallel_size=2)
tokenizer = AutoTokenizer.from_pretrained('/HOME/paratera_xy/pxy368/HDD_POOL/yuting/models/Qwen2.5-32B-Instruct')
...
os.makedirs(f"/HOME/paratera_xy/pxy368/HDD_POOL/yuting/inference/judge/{args.benchmark}/", exist_ok=True)
print(args.benchmark, num/len(data_list))
with open(save_path, 'w', encoding='utf-8') as out_file:
    json.dump(finals, out_file, ensure_ascii=False, indent=4)


os.makedirs(f"/HOME/paratera_xy/pxy368/HDD_POOL/yuting/inference/final-results/{args.benchmark}/", exist_ok=True)
accuracy = num/len(data_list)
final_save_path = (
    f"/HOME/paratera_xy/pxy368/HDD_POOL/yuting/inference/final-results/{args.benchmark}/{args.model}_accuracy_{accuracy:.4f}.json"
)
